...
2.  Con la base de datos creada deben abrir el archivo de la solución (SesaAPI.slnx) usando Visual Studio 2016. Hacer clic derecho en el proyecto SesaAPI y selecionar "Establecer como proyecto de inicio". Con esto ya pueden ejecutar el proyecto, ya sea en https, http o IIS Express.
